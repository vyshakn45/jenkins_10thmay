...
public void user_is_on_hotel_booking_page() throws Throwable {
	...
	//driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	//objhbpg = new HotelBookingPageFactory(driver);
	driver.get("file:///F:/internship/AHotelbooking/hotelBooking/hotelBooking/hotelbooking.html");
}
...
public void navigate_to_welcome_page() throws Throwable {
	driver.navigate().to("file:///F:/internship/AHotelbooking/hotelBooking/hotelBooking/success.html");
